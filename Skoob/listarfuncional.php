...
<?php
  ...
  # VERIFICA SE $_POST DE PESQUISA É NULO << SE TIRAR APARECE ERRO >>
...
printf("<a href='/como-treinar-o-seu-dragao-95122ed105205.html' title='Como Treinar o Seu Dragão'   class='capa-link-item'><img src=".$row["ds_url_capa_livro"] ."  alt='Como Treinar o Seu Dragão'  title='Como Treinar o Seu Dragão' width='70px;' height:'120px;' class='cpimg'  itemprop='image' /></a>");
printf("<br /> 
<div style='padding:4px 0 0 4px;clear:both;' class='star-mini'>
           ...
           printf("</div><div class='detalhes' style='border:none;'><a href='livro.php?isbn=".$row["cd_isbn_10_livro"]."' style='font-size:15px;font-weight:bold;'>".$row["nm_livro"]."</a><br /><a href='/livro/lista/Cressida+Cowell/tipo:autor/' style='margin:5px 0 5px 0;'>".$row["fk_cd_autor"]."</a><div style='color:#556677;font-size:11px; border:0px solid red; margin-top:6px; width:200px;'><span>Ano:". $row["dt_lancamento"] ."</span><span> / Páginas:". $row["nr_pagina_livro"]. "</span></div></div><div class='detalhes-2'><div class='detalhes-2-sub'><div style='border:none; float:left;'>");


           printf("<span style='color:#556677;font-size:10px;'><img src='https://s3-sa-east-1.amazonaws.com/skoob-sp/flag/br.gif' class='bandeira' /> 9788598078717 <!-- cd_isbn_13_livro --></span><span class='bar'> | </span><span><a href=/editora/11-intrinseca> ".$row['nm_editora']. "</a></span><span> | </span><span><a href='/livro/edicoes/95122/edicao:105205'>2 edições <!-- retirar --></a></span><span> | </span><span style='color:#556677;font-size:10px;'>".rand(0,25000)." leitores <!-- retirar --> </span></div><div style='border:none; float:right; text-align:right;'>       <div class='sidebar-buy' data-ng-controller='ofertaCtrl' style='font-size:13px; border:none; width:180px;'>");
                   printf("<div>
