...
<div id="myModal" class="modal  hide fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
          ...
          <div data-ng-controller="bookcaseMenu" data-ng-init="menu(3967192, 'books')" style="float: left; width: 160px; border:0px solid red;">
               <div class="tmp-menu-left" style="padding:0px; margin:5px 0px 0px 0px;">
                    <ul style="margin:0px; padding:0px; list-style-type:none;">
                        <li class="lista"><div><i class="icon-table " style="margin:0px 6px 2px 2px;"></i><a href="estantequeroler.php" data-ng-click="estante('books', 3967192, 0, 1)">Quero ler</a><br></div><div data-ng-class="{'blistaon badge':estante_id == '', 'blista':estante_id !== ''}"><span ng-bind='stats.total'></span><?php echo($numQueroLer);?></div></li>
                        <li class="lista"><div><i class="icon-adicionar sk-cor-lido" style="margin:0px 10px 2px 4.5px;"></i><a href="estantetodos.php" data-ng-click="estante('books', 3967192, 1, 1)">Todos</a></div><div data-ng-class="{'blistaon badge':estante_id === 1, 'blista':estante_id !== 1}"><span ng-bind='stats.lido'></span><?php echo($numTotal);?></div></li>
                        <li class="lista"><div><i class="icon-adicionar sk-cor-vouler" style="margin:0px 10px 2px 4.5px;"></i><a href="estantelido.php" data-ng-click="estante('books', 3967192, 3, 1)">Lido</a></div><div  data-ng-class="{'blistaon badge':estante_id === 3, 'blista':estante_id !== 3}"><span ng-bind='stats.quero_ler'></span><?php echo($numLido);?></div></li>     
                     </ul>
               </div>
          ...
          <div style="width: 780px; float: right; margin-left:0px; border: 0px solid red; margin-top: 3px;">
            ...
            <?php
                ...
                if(mysql_num_rows($resultQueroLer) > 0){
                    while ($row = mysql_fetch_assoc($resultQueroLer)) {
