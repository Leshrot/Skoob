...
<script type="text/javascript" src="https://cache.skoob.com.br/local/skoob/js/angularjs/base.min.js?1465578598"></script><script type="text/javascript" src="https://cache.skoob.com.br/local/skoob/js/angularjs/main.min.js?1467933083"></script><link rel="stylesheet" type="text/css" href="https://cache.skoob.com.br/local/skoob/css/ver2/main.min.css?1473946186"/>
      ...
      <script type="text/javascript">      
            ...
            document.getElementById('ufile').addEventListener('change', readURL, true);
            function readURL(){
    ...
    <?php
          ...
          $result = mysql_query("SELECT ds_img_leitor from tb_leitor where ds_senha_leitor = '$senha' and ds_img_leitor is not null;");
          if(mysql_num_rows($result) == 1){

              $row = mysql_fetch_assoc($result);
              if(trim($row['ds_img_leitor']) != null){
                echo('<style type="text/css">
                #fotoperfil, #menorfotoperfil{
                  background-image:url("img/leitor/'.$row['ds_img_leitor'].'");
                }
                </style>');
              }             
          }
                     ...
                     <ul class="nav nav-pills" style='margin: 0px;'>
                          <li class="dropdown">
                               <a href="#" id="topo-menu-conta" class="dropdown-toggle">
                                    <img id='menorfotoperfil' style="margin-right:10px; float:left; padding:0px;" width="27" height="27" alt=""/>                                    <b class="caret"></b>
                               </a>
...
<div id="perfil-usuario-foto" ng-mouseover='perfil_foto_trocar = true'  ng-mouseleave='perfil_foto_trocar = false' style="border:none; height: 173px; width: 173px; overflow: hidden; background-color:transparent; -moz-border-radius: 5px; border-radius: 5px;" >
  <form action="upload.php" name="alterar_foto_perfil" method="post" enctype="multipart/form-data" runat="server">
    <input type="file" id="ufile"  name="ufile" style="width: 0px; height: 0px;" onchange="readURL(this);">
    <input type="submit" name="Submit" id="Submit" style="width: 0px; height: 0px; display: transparent;" value="Upload" />
  </form>
  <a href='#' ng-if='perfil_foto_trocar' id='perfil-usuario-foto-troca' onclick="doOnClick();" ng-cloak><i class='icon-camera'>
    
  </i> Mudar foto</a>  
  
    <img id="fotoperfil" width='173' height='173'>
</div>
