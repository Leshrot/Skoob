...
<html xmlns='//www.w3.org/1999/xhtml'>
    <head prefix="og: http://ogp.me/ns# fb: http://ogp.me/ns/fb# books: http://ogp.me/ns/books#">
        <meta http-equiv="Content-Type" content="text/html;  charset=utf-8" />        <title>Usuario</title>
...
<div id=""><ul class="nav nav-tabs"><li ><a href="/usuario/editar_cadastro">Dados Cadastrais</a></li><li ><a href="/usuario/editar_perfil/">Perfil</a></li><li ><a href="/usuario/editar_login/">Login e senha</a></li><li class="active"><a href="/usuario/editar_foto/">Foto</a></li><li ><a href="/usuario/emails/">Emails</a></li><li ><a href="/usuario/twitter/">Twitter</a></li><li ><a href="/usuario/facebook/">Facebook</a></li><li ><a href="/widget/">Widgets</a></li><li ><a href="/usuario/excluir/">Outros</a></li></ul></div>
<style type="text/css">
          #boxEsquerdo {
                    float:left;
                    padding:0px;
...
mysql_connect("localhost","root","") or
  ...
  move_uploaded_file($_FILES['arquivo']['tmp_name'], $fotos.$novo_nome);

    $sql = mysql_query("INSERT INTO upload (arquivo) VALUES( '$novo_nome')");
  if ($sql){
...
<div id="boxCadastro" style='width:960px;'>
                    <div style="text-align:left; border:#ccc 0px solid; margin-top:0px; padding:0px; width:960px; ">
                    <h2 style='font-size:18px; border-bottom:#000 1px solid; padding-bottom:5px; margin:0px; margin-bottom:12px;'>Cadastre sua foto</h2>
                    <br />
                    <div id="boxCrieSuaConta" style='float:left; width:940px;'>
                              <div style='float:left; text-align:center;'><img src="https://cache.skoob.com.br/local/images//GkZv10ulnFNGyAlYNoNJC4Nc6Mg=/170x170/center/top/smart/filters:format(jpeg)/https://skoob-sp.s3.amazonaws.com/img/v2/base/sem-face-h-default.gif" style="float:left; margin-right:8px; padding:5px;border:#ccc 1px solid; background-color:#fff" alt=""/><br clear='all' /><br clear='all'></div>                              <div id="boxFoto" style="border:1px solid #e4e4e4; padding: 15px; width: 700px;">
                                                                                <form name='form' action='/Skoob/editar_foto.php/' enctype="multipart/form-data" method="post">
                                                  <div style='float:left; width:700px; padding:5px;'><br>
                                                            <input type="file" required name="arquivo" id="UsuarioFoto"/><br>
                                                            <div class="submit"><input class="btn btn-primary" type="submit" value="Enviar foto"/></div><br />
                                                            Você pode enviar arquivos JPG, GIF, BMP ou PNG (tamanho máximo de 10MB). Não envie fotos que contenham imagens de personagens de desenho animado, pessoas famosas, nudez, trabalho artístico ou material protegido por direitos autorais.
                                                  </div>
                                                  <br style='clear:both;'>
                                        </form>
                              </div>
