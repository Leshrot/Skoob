          ...
          <div data-ng-controller="bookcaseMenu" data-ng-init="menu(3967192, 'books')" style="float: left; width: 160px; border:0px solid red;">
               <div class="tmp-menu-left" style="padding:0px; margin:5px 0px 0px 0px;">
                    <ul style="margin:0px; padding:0px; list-style-type:none;">
                         <li class="lista"><div><i class="icon-table " style="margin:0px 6px 2px 2px;"></i><a href="estantelido.php" data-ng-click="estante('books', 3967192, 0, 1)">Lido</a><br></div><div data-ng-class="{'blistaon badge':estante_id == '', 'blista':estante_id !== ''}"><span ng-bind='stats.total'></span></div></li>
